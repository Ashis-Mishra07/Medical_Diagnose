...
# Remove this line: from langchain_anthropic import ChatAnthropic
...
from utils import (
    ...
    clean_html_to_text,
    extract_headlines,
    summarize_with_groq_news_script,  # Changed from summarize_with_anthropic_news_script
        ...
        for topic in topics:
            async with self._rate_limiter:
                try:
                    ...
                    summary = summarize_with_groq_news_script(  # Changed function name
                        api_key=os.getenv("GROQ_API_KEY2"),  # Changed API key
                        headlines=headlines
                    )
