...
<div style="text-align: center; margin-bottom: 20px;">
    <h1 style='color: #4CAF50; margin: 0;'>Hopeful Health Companion</h1>
</div>
...
with st.sidebar:
    selected = option_menu(
        'Health Services',
        ['Overview','Disease Prediction', 'Diagnosis', 'Medical Chatbot', 
         'Instant Medication', 'Prescription Analyser', 'Medical News'],  
        menu_icon='hospital-fill',
        icons=['activity', 'search-heart', 'chat-dots', 'capsule', 'file-medical', 'newspaper' , 'info-circle'],  
        default_index=0
    )
...
if selected == 'Overview':
    ...
    st.title('ℹ️ Get a Quick Overview')
